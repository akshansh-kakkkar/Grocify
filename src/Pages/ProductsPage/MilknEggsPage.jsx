                ...
                <div className="flex justify-between w-full">
                  ...
                  {!cartIncludes ? (
                    <motion.div
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-b from-orange-400 cursor-pointer h-fit items-center flex to-orange-500 p-1 rounded-lg"
                    >
                      <FontAwesomeIcon
                        icon={faPlus}
                    ...
                    <motion.div
                      ...
                      className="bg-gradient-to-b cursor-pointer from-red-500 h-fit items-center flex to-red-400 py-2 p-1 rounded-lg"
                    >
                      <FontAwesomeIcon
                        icon={faTrash}
                        className="text-white text-xl"
