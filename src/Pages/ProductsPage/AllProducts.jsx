...
import { faPlus, faHeart, faTrash } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="flex justify-between w-full">
                  ...
                  {!cartIncludes ? (
                    ...
                    <motion.div
                      ...
                      whileHover={{ scale: 1.1 }}
                      whileTap={{ scale: 0.95 }}
                      className={`bg-gradient-to-b cursor-pointer from-red-400 py-2 h-fit items-center flex to-red-500 p-1 rounded-lg `}
                    >
                      <FontAwesomeIcon
                        icon={faTrash}
                        className="text-white text-xl"
