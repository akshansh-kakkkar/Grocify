  ...
  return (
    <div>
      <div className="h-[85vh] mx-12 flex flex-col">
        ...
        <div className="bg-orange-400 flex items-center justify-center ml-32 w-24 mt-2 h-1 rounded-full"></div>
        <div className="flex justify-center gap-12 h-full mx-12 items-center">   
        <div className="flex justify-center items-center">
          <div>
            ...
            <div className="flex gap-5 mt-2 ">
              ...
              <div>
                <h2 className="poppins text-xl font-bold">{Purposes[0].name}</h2>
              <p className="w-65 text-sm inter text-[#686868]">{Purposes[0].description}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="flex gap-5 mt-2 ">
              ...
              <div>
                <h2 className="poppins text-xl font-bold">{Purposes[2].name}</h2>
              <p className="w-65 text-sm inter text-[#686868]">{Purposes[2].description}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="flex gap-5 mt-2 ">
              ...
              <div>
                <h2 className="poppins text-xl font-bold">{Purposes[3].name}</h2>
              <p className="w-65 text-sm inter text-[#686868]">{Purposes[3].description}</p>
              </div>
            </div>
          </div>
        </div>
