  ...
  return (
    <div className="w-full select-none h-[300px] bg-[#f5f5f5] flex items-center ">
      <div className="flex item-center text-orange-500 font-bold  text-center">
        <div className="md:text-9xl text-6xl inter -rotate-90 ">upto 20%</div>
      </div>
      <div className="flex gap-3 md:gap-5 flex-col">
        ...
        <motion.div onClick={()=>Navigate('all-products')} whileHover={{scale:1.1}} whileTap={{scale:0.95}}  className="cursor-pointer select-none bg-gradient-to-b from-orange-400 to-orange-500 w-fit text-white text-md md:text-xl flex items-center justify-center py-1 px-2 md:py-3 md:px-4 rounded-sm">Buy Now</motion.div>
      </div>
      <div>
